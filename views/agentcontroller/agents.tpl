                ...
                <div id="toolbar" class="data-collapse">
                    <form id="search-form" class="form-inline" role="form">
                        ...
                        <button id="btn-add" type="button" class="btn-danger form-control"
                                ...
                                data-remote="{{.domain}}forms/?a=add_agent_child&id={{.user.Id}}&rate={{.user.Rate}}"><span
                                class="fa fa-plus"></span>添加代理
                        </button>
                    </form>
                </div>
...
<script>
    datacolumns = [
        ...
        {title: '玩家总税收', field: 'total_tax', formatter: fishApp.formatter.gold},
